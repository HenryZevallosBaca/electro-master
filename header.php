			...
			<div id="top-header">
				<div class="container">
					...
					<ul class="header-links pull-right">
						...
						<li><a href="./new_user.php"><i class="fa fa-user-o"></i> Registrar cuenta</a></li>
						<li><a href="./user.php"><i class="fa fa-user-o"></i> Cuentas Registradas</a></li>
					</ul>
				</div>
			</div>
			<!-- /TOP HEADER -->
						...
						<div class="col-md-6">
							<div class="header-search">
								<form>
									...
									<input class="input" placeholder="Search here"><button class="search-btn">Buscar</button>
								</form>
							</div>
						</div>
						<!-- /SEARCH BAR -->
